...
# GCC 15 host tools, notably libcody, are not C++20 char8_t-clean.
# Keep the compiler command itself on the C++ dialect GCC 15 was written for;
# libcody's configure test checks CXX before it applies CXXFLAGS.
: "${CXX:=g++}"
